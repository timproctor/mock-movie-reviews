...
Movie.create!([
  ...
  },
  {
    ...
    description:
    %{
      One of the best Philip K. Dick adaptations from the short story "Do Androids Dream
      of Electric Sheep?"
    }.squish,
    image_file_name: 'blade-runner.jpg',
    cast: 'Harrison Ford, Rutger Hauer, Sean Young',
    released_on: "1982-06-25",
    duration: '157 min',
    director: 'Ridley Scott',
    rating: 'R',
    total_gross: 28000000.00
  }
])
